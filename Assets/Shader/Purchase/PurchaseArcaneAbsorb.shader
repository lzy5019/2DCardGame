Shader "UI/PurchaseArcaneAbsorb"
{
    Properties
    {
        ...
        _FlowGlow ("Flow Glow", Range(0, 4)) = 1.4
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float sweepCenter = lerp(-_FlowWidth, 1.0 + _FlowWidth, saturate(progress * 1.15));
                float sweepBand = 1.0 - smoothstep(_FlowWidth * 0.45, _FlowWidth, abs(projected - sweepCenter));
                ...
                resultRgb += chargeRgb * sweepBand * _FlowGlow;
                ...
                resultAlpha = max(resultAlpha, baseCol.a * sweepBand * 0.35 * (1.0 - progress * 0.25));
